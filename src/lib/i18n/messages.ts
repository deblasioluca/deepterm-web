...
export const appMessages: Record<AppLocale, AppMessages> = {
  ...
  de: {
    ...
    sidebar: { account: 'Konto', team: 'Team', vaults: 'Tresore', samlSso: 'SAML SSO', twoFactorAuth: 'Zwei-Faktor-Auth', passkeys: 'Passkeys', billing: 'Abrechnung', forStudents: 'Für Studierende', ideas: 'Ideen', getTheApp: 'App herunterladen', issues: 'Probleme', securityAssessment: 'Sicherheitsbewertung', helpFeedback: 'Hilfe & Feedback', messages: 'Nachrichten', audioChannels: 'Audiokanäle', logOut: 'Abmelden', expandSidebar: 'Seitenleiste erweitern', collapseSidebar: 'Seitenleiste einklappen' },
  ...
  es: {
    ...
    sidebar: { account: 'Cuenta', team: 'Equipo', vaults: 'Bóvedas', samlSso: 'SAML SSO', twoFactorAuth: 'Autenticación de dos factores', passkeys: 'Passkeys', billing: 'Facturación', forStudents: 'Para estudiantes', ideas: 'Ideas', getTheApp: 'Obtener la app', issues: 'Incidencias', securityAssessment: 'Evaluación de seguridad', helpFeedback: 'Ayuda y feedback', messages: 'Mensajes', audioChannels: 'Canales de audio', logOut: 'Cerrar sesión', expandSidebar: 'Expandir barra lateral', collapseSidebar: 'Contraer barra lateral' },
